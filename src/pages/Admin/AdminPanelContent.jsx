    ...
    const generalCard = [
        {
            title: "Ürün Sayısı",
            count: 105,
            svg: `<svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-archive" viewBox="0 0 16 16">
        ...
        },
        {
            title: "Üye Sayısı",
            count: 30,
            svg: `<svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-person-video" viewBox="0 0 16 16">
        ...
        },
        {
            ...
            count: 5,
            svg: `<svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-tags" viewBox="0 0 16 16">
